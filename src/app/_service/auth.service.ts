...
export class AuthService {
  ...
  register(body: RegisterDto) {
    let dto = { ...body, email: this.encryptWithPublicKey(body.email), password: this.encryptWithPublicKey(body.password), pylon: this.getPylon() };
  ...
  login(mail: string, password: string) {
    let dto: LoginDto = { email: this.encryptWithPublicKey(mail), password: this.encryptWithPublicKey(password), pylon: this.getPylon() };
  ...
  resetEmailRequest(body: ChangeEmailRequestDto) {
    let dto = { ...body, old_email: this.encryptWithPublicKey(body.old_email), new_email: this.encryptWithPublicKey(body.new_email), pylon: this.getPylon() };
  ...
  terminateMembershipRequest() {
    ...
    let dto: TerminateMembershipRequestDto = { email: this.encryptWithPublicKey(userMail), pylon: this.getPylon() };
