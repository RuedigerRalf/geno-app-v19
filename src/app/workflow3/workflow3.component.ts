...
@Component({
  selector: 'app-workflow3',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './workflow3.component.html',
  styleUrl: './workflow3.component.scss' 
})
export class Workflow3Component implements AfterViewInit, OnDestroy {
